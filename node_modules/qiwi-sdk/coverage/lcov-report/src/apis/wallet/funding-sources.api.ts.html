...
<head>
    <title>Code coverage report for src/apis/wallet/funding-sources.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apis/wallet</a> funding-sources.api.ts</h1>
        <div class='clearfix'>
...
<a name='L92'></a><a href='#L92'>92</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { url } from "../shared";
...
&nbsp;
   ...
   * @memberof WalletFundingSourcesApi
   */
<span class="fstat-no" title="function not covered" >  async </span>createAccount(alias: string): Promise&lt;void&gt; {
    // Деструктивный метод
...
&nbsp;
   ...
   * @memberof WalletFundingSourcesApi
   */
<span class="fstat-no" title="function not covered" >  async </span>setDefaultAccount(alias: string): Promise&lt;void&gt; {
    // Деструктивный метод
    /* istanbul ignore next */
