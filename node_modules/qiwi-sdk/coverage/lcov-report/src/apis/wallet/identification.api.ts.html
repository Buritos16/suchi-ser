...
<head>
    <title>Code coverage report for src/apis/wallet/identification.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apis/wallet</a> identification.api.ts</h1>
        <div class='clearfix'>
...
<a name='L53'></a><a href='#L53'>53</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
export class WalletIdentificationApi extends WalletApi {
   ...
   */
<span class="fstat-no" title="function not covered" >  async </span>set(data: IdentificationBase): Promise&lt;IdentificationResponse&gt; {
