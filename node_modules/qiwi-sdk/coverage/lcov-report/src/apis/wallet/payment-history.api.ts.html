...
<head>
    <title>Code coverage report for src/apis/wallet/payment-history.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apis/wallet</a> payment-history.api.ts</h1>
        <div class='clearfix'>
...
<a name='L129'></a><a href='#L129'>129</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
&nbsp;
   ...
   * @memberof WalletPaymentHistoryApi
   */
<span class="fstat-no" title="function not covered" >  async </span>sendTransactionCheque(
    transactionId: StringOrNumber,
    type: TransactionTypeAny,
    email: string
  ): Promise&lt;void&gt; {
