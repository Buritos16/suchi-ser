...
<head>
    <title>Code coverage report for src/apis/p2p/p2p.middleware.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apis/p2p</a> p2p.middleware.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type { Request, RequestHandler } from "express";
...
&nbsp;
  return new Promise((resolve, reject) =&gt; {
    let body = "";
&nbsp;
    request.on("error", <span class="fstat-no" title="function not covered" >(e</span>rror) =&gt; <span class="cstat-no" title="statement not covered" >reject(error))</span>;
