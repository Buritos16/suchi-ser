...
<head>
    <title>Code coverage report for src/apis/p2p/bills.api.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/apis/p2p</a> bills.api.ts</h1>
        <div class='clearfix'>
...
<a name='L266'></a><a href='#L266'>266</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
&nbsp;
   ...
   * @memberof P2pBillsApi
   */
<span class="fstat-no" title="function not covered" >  async </span>refund(
    billId: string,
...
&nbsp;
   ...
   * @memberof P2pBillsApi
   */
<span class="fstat-no" title="function not covered" >  async </span>getRefundStatus(
    billId: string,
    refundId: string
  ): Promise&lt;BillRefundStatusData&gt; {
    /* istanbul ignore next */
