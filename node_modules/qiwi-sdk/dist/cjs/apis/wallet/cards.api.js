"use strict";
const uuid = require("../shared/uuid.js"),
...
class WalletCardsApi extends api.WalletApi {
  ...
  async block(cardId) {
    await this.http.put(
      url.url`cards/v2/persons/${this.walletId}/cards/${cardId}/block`
    );
  }
  /**
   * ## Разблокировка карты
  ...
  async unblock(cardId) {
    return await this.http.put(
      url.url`cards/v2/persons/${this.walletId}/cards/${cardId}/unblock`
    );
  }
  /**
  ...
  async getRequisites(cardId) {
    return await this.http.put(url.url`cards/v1/cards/${cardId}/details`, {
  ...
  async rename(cardId, alias) {
    return await this.http.put(url.url`cards/v1/cards/${cardId}/alias`, { alias });
  }
}
