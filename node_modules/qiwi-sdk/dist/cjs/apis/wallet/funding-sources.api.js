...
class WalletFundingSourcesApi extends api.WalletApi {
  ...
  async getAccounts() {
    const { accounts } = await this.http.get(
      url.url`funding-sources/v2/persons/${this.walletId}/accounts`
    );
    return accounts;
  }
  /**
  ...
  async getAccountOffers() {
    return await this.http.get(
      url.url`funding-sources/v2/persons/${this.walletId}/accounts/offer`
    );
  }
  /**
  ...
  async setDefaultAccount(alias) {
    return await this.http.patch(
      url.url`funding-sources/v2/persons/${this.walletId}/accounts/${alias}`,
      { defaultAccount: true }
    );
  }
}
