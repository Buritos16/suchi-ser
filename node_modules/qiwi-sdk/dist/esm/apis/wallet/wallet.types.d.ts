...
export type PersonIdentificationLevelAny = PersonIdentificationLevel | PersonIdentificationLevelPlain;
...
export declare const Recipient: typeof Recipients;
...
export type PaymentHistorySourceAny = PaymentHistorySource | PaymentHistorySourcePlain;
...
export type GetPaymentHistoryParameters = GetPaymentHistoryParametersBase | (GetPaymentHistoryParametersBase & GetPaymentHistoryParametersStartEnd) | (GetPaymentHistoryParametersBase & {
    /**
...
export type GetPaymentHistoryTotalParameters = Omit<GetPaymentHistoryParametersBase, "rows"> & GetPaymentHistoryParametersStartEnd;
...
export type Limit<Current extends keyof typeof Currency = "RUB", Type extends LimitTypeAny = LimitTypeAny> = {
    /** Валюта операций */
    currency: Current;
    /**
