 ...
 * @extends {WalletApi}
 */
class WalletOauthApi extends WalletApi {
  constructor() {
    super(...arguments);
    this._http = new SimpleJsonHttp();
  }
  /**
   *
   *
  ...
  async createToken() {
    ...
    const codeResponse = await http.post(url`authorize`, {
      response_type: "code",
      client_id: WalletOauthApi.CLIENT_ID,
      token: this._options.token,
      client_software: WalletOauthApi.CLIENT_SOFTWARE
    });
    const tokenResponse = await http.post(url`token`, {
