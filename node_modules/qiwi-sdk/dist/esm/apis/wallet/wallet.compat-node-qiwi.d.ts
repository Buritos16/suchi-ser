...
export declare class _WalletCompatNodeQiwi extends Wallet {
     ...
     * @memberof _WalletCompatNodeQiwi
     */
    getHistory(contractId: string | number, settings?: Partial<types.GetPaymentHistoryParameters>): Promise<types.GetTransactionsHistoryResponse>;
    /**
     *
     *
     * @param {(string | number)} contractId
     ...
     * @memberof _WalletCompatNodeQiwi
     */
    getTransactionsStats(contractId: string | number, settings: types.GetPaymentHistoryTotalParameters): Promise<types.GetPaymentHistoryTotalResponse>;
    /**
     *
     *
