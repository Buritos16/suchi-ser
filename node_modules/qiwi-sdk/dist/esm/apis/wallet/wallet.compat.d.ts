...
export declare class _WalletCompat extends Wallet {
     ...
     * @param {types.StringOrNumber} [walletId] Номер телефона привязанный к кошельку
     */
    getPaymentHistory(parameters: types.GetPaymentHistoryParameters, walletId?: types.StringOrNumber): Promise<types.GetTransactionsHistoryResponse>;
    /**
     ...
     * @param {types.StringOrNumber} [walletId] Номер телефона привязанный к кошельку
     */
    getPaymentHistoryTotal(parameters: types.GetPaymentHistoryTotalParameters, walletId?: types.StringOrNumber): Promise<types.GetPaymentHistoryTotalResponse>;
    /**
